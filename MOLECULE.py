...
c.execute("INSERT INTO MOLECULE VALUES (1, 'WATER', 'H20', '600_1%_532e_Mo F1_80sec.asc')");
...
c.execute("INSERT INTO MOLECULE VALUES (7, 'GLUOCOSE', 'C6H1206', 'Pr25%Al75%FeGeO_RTP_R12')");
