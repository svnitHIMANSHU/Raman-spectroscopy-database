...
class MyFrame(wx.Frame):
    ...
    def __init__(self):
        ...
        wx.StaticText(self.p, -1, "What are the values of X", pos=(10, 12))

        wx.CheckBox(self.p, -1, "Apples", (20,100), (160,-1))
        wx.CheckBox(self.p, -1, "Mango", (20,150), (160,-1))
        wx.CheckBox(self.p, -1, "Banana", (20,200), (160,-1))
        wx.CheckBox(self.p, -1, "Orange", (20,250), (160,-1))
